                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("PICPOTO-Coin") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a PPO address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and ppo: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About PPO Core"), this);
    aboutAction->setStatusTip(tr("Show information about PPO Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for PPO"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your PPO addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified PPO addresses"));
    ...
    openAction->setStatusTip(tr("Open a PPO: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the PPO Core help message to get a list with possible PPO command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("PPO Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to PPO network", "", count));
}
...
{
    QString strTitle = tr("PPO Core"); // default title
