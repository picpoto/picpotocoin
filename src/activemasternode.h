...
// Copyright (c) 2015-2016 The Picpoto developers
...
private:
    ...
    /// Get 10000 PPO input that can be used for the Masternode
...
{
public:
    /// Is the inputs associated with this public key? (and there is 10000 PPO - checking if valid masternode)
