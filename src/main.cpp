...
#if defined(NDEBUG)
#error "PPO cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "PPO Signed Message:\n";
...
int64_t GetBlockValue(int nHeight)
{
	...
	{nSubsidy = 1 * COIN;} 
	else if (nHeight > 240 && nHeight <= 36810) 
	{nSubsidy = 70 * COIN;} 
	else if (nHeight > 36810 && nHeight <= 36811) 
	{nSubsidy = 500000 * COIN;} 
	else if (nHeight > 36811 && nHeight <= 50000) 
	{nSubsidy = 140 * COIN;} 
	else if (nHeight > 50000 && nHeight <= 58260) 
	{nSubsidy = 350 * COIN;} 
	else if (nHeight > 58260 && nHeight <= 58261) 
	{nSubsidy = 199300000 * COIN;} 
	else if (nHeight > 58261 && nHeight <= 60000) 
	{nSubsidy = 350 * COIN;} 
