...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* PPO features */
        {"ppo", "masternode", &masternode, true, true, false},
        {"ppo", "masternodelist", &masternodelist, true, true, false},
        {"ppo", "mnbudget", &mnbudget, true, true, false},
        {"ppo", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"ppo", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"ppo", "mnsync", &mnsync, true, true, false},
        {"ppo", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use ppod, or the -server option to ppo-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> ppo-cli " + methodname + " " + args + "\n";
}
