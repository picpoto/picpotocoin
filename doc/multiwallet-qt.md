...
In order to support loading of multiple wallets in ppo-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is ppo.cpp.
...
Changes to ppo.cpp
----------------------
ppo.cpp is the entry point into ppo-qt, and as such, will require some minor modifications to provide hooks for
