...
RESOURCES += src/qt/ppo.qrc src/qt/ppo_locale.qrc

TRANSLATIONS += src/qt/locale/ppo_bg.ts \
                src/qt/locale/ppo_de.ts \
                src/qt/locale/ppo_en.ts \
                src/qt/locale/ppo_es.ts \
                src/qt/locale/ppo_fi.ts \
                src/qt/locale/ppo_fr.ts \
                src/qt/locale/ppo_it.ts \
                src/qt/locale/ppo_ja.ts \
                src/qt/locale/ppo_pl.ts \
                src/qt/locale/ppo_pt.ts \
                src/qt/locale/ppo_ru.ts \
                src/qt/locale/ppo_sk.ts \
                src/qt/locale/ppo_sv.ts \
                src/qt/locale/ppo_vi.ts \
                src/qt/locale/ppo_zh_CN.ts \
                src/qt/locale/ppo_zh_TW.ts
