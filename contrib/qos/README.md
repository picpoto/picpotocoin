...
This means one can have an always-on ppod instance running, and another local ppod/ppo-qt instance which connects to this node and receives blocks from it.
